  ...
  export default {
    ...
    data() {
      return {
        moduleInfo: {
          title: 'Araçlar',
          createRoute: '/cars/add',
          editRoute: '/cars/',
          createText: 'Araç Oluştur'
        },
        deleteDialog: {
          open: false,
          deleteItem: null,
          loader: false,
          options: {
            endpoint: 'cars/delete',
            endpointVal: 'id',
            title: 'Silme İşlemi',
            text: '{plaque} Plakalı Aracı Silmek istediğinize emin misiniz?',
            showText: '',
            successText: '{plaque} Plakalı Araç Silinmiştir',
          }
        },
        detailDialog: {
          open: false,
