  ...
  export default {
    ...
    data() {
      return {
        moduleInfo: {
          title: 'Müşteriler',
          createRoute: '/customers/add',
          editRoute: '/customers/',
          createText: 'Müşteri Oluştur'
        },
        deleteDialog: {
          open: false,
          deleteItem: null,
          ...
          options: {
            ...
            endpointVal: 'id',
            title: 'Silme İşlemi',
            text: '{title} İsimli Müşteriyi Silmek istediğinize emin misiniz?',
            showText: '',
            successText: '{title} İsimli Müşteri Silinmiştir',
          }
        },
        detailDialog: {
          open: false,
