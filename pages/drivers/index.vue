  ...
  export default {
    ...
    data() {
      return {
        moduleInfo: {
          title: 'Sürücüler',
          createRoute: '/drivers/add',
          editRoute: '/drivers/',
          createText: 'Sürücü Oluştur'
        },
        deleteDialog: {
          open: false,
          deleteItem: null,
          ...
          options: {
            ...
            endpointVal: 'id',
            title: 'Silme İşlemi',
            text: '{tc_no} Nolu Sürücüyü Silmek istediğinize emin misiniz?',
            showText: '',
            successText: '{tc_no} Nolu Sürücü Silinmiştir',
          }
        },
        detailDialog: {
          open: false,
        ...
        table: {
          ...
          headers: [
            ...
            {text: 'İsim Soyisim', value: 'name_surname'},
            {text: 'TC', value: 'tc_no'},
          ],
          items: []
        },
