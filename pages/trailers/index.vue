  ...
  export default {
    ...
    data() {
      return {
        moduleInfo: {
          title: 'Dorseler',
          createRoute: '/trailers/add',
          editRoute: '/trailers/',
          createText: 'Dorse Oluştur'
        },
        deleteDialog: {
          open: false,
          deleteItem: null,
          loader: false,
          options: {
            endpoint: 'trailers/delete',
            endpointVal: 'id',
            title: 'Silme İşlemi',
            text: '{plaque} Plakalı Dorseyi Silmek istediğinize emin misiniz?',
            showText: '',
            successText: '{plaque} Plakalı Dorse Silinmiştir',
          }
        },
        detailDialog: {
          open: false,
